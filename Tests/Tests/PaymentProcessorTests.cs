...
namespace BitShift.Plugin.Payments.FirstData.Tests
{
  ...
  public class PaymentProcessorTests// : BaseValidatorTests
  {
    ...
    private Mock<IPluginFinder> _pluginService;
    ...
    public void Setup()
    {
      ...
      _pluginService = new Mock<IPluginFinder>();
      ...
      _pluginService.Setup(p => p.GetPluginDescriptorBySystemName<FirstDataPaymentProcessor>(It.IsAny<string>(),
        It.IsAny<LoadPluginsMode>())).Returns(pluginDescriptor);
      ...
      _genericAttributeService.Setup(g => g.GetAttribute<string>(It.IsAny<Customer>(), It.IsAny<string>(), It.IsAny<int>())).Returns("");
